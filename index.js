...
class Customer {
    ...
    accountNumber;
    bankAccount;
    constructor(firstName, lastName, age, gender, accountNumber, bankAccount) {
...
const customers = [
    new Customer("John", "Doe", 30, "Male", 1001, new BankAccount(100)),
    new Customer("Jane", "Smith", 25, "Female", 1002, new BankAccount(300)),
    new Customer("Bob", "Johnson", 35, "Male", 1003, new BankAccount(250)),
    new Customer("Marrie", "Kristen", 22, "Female", 1004, new BankAccount(400)),
    new Customer("Miguel", "Lopez", 28, "Male", 1005, new BankAccount(500)),
];
